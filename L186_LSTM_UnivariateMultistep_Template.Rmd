...
```{r}
c(X_train, y_train) %<-% lstm_reshape(data = train$y, n_timesteps = 10, n_features = 1, n_timesteps_pred = 1)
c(X_valid, y_valid) %<-% lstm_reshape(data = valid$y, n_timesteps = 10, n_features = 1, n_timesteps_pred = 1)
c(X_test, y_test) %<-% lstm_reshape(data = test$y, n_timesteps = 10, n_features = 1, n_timesteps_pred = 1)
```
